...
Cell04Model = EffectCellMode:extend()

function Cell04Model:new()

    Cell04Model.super.new(CellModelDefinition.CellId.CELL_04)

    self._rechargeTime = 25.0;
    self._distance = 1.5;
    self._cost = 50;
    self._beEaten = false;

    self._hp = 80;
    self._effectRechargeTime = 0.5;
    self._effectTimeCounter = 0.5;
end



function Cell04Model:canPutOn(level, cellX, cellY)
...
function Cell04Model:update(dt)

end

function Cell04Model:draw()
